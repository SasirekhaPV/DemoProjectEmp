				...
				<div class="row">
					<div class=" col-sm-6 form-group">
						<label>Emp Id</label> <input type="text"
							value="${emp.getEmp_ID()}" readonly="readonly" name="Emp_ID"
							class="form-control" type="number" maxlength="6" pattern="\d{6}"
							required />
					</div>
					<div class=" col-sm-6 form-group">
				...
				<div class="row">
					...
					<div class="col-sm-6 form-group">
						<label>Last Name</label> <input type="text"
							value="${emp.getEmp_Last_Name()}" name="Emp_Last_Name"
							class="form-control" required />
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 form-group">
						...
						<label>Date of Joining</label> <input type="date"
							value="${emp.getEmp_Date_of_Joining()}" class="form-control"
							name="Emp_Date_of_Joining" required />
					</div>
					<div class="col-sm-6 form-group">
						<!-- Date input -->
						<label>Date of Birth</label> <input type="date"
							value="${emp.getEmp_Date_of_Birth()}" class="form-control"
							name="Emp_Date_of_Birth" required />
					</div>
				</div>
				<div class="form-group">
					<label>Address</label> <input value="${emp.getEmp_Home_Address()}"
				...
				<div class="row">
					<div class="col-sm-4 form-group">
						<label>Phone Number</label> <input type="text"
							name="Emp_Contact_Num" class="form-control"
							value="${emp.getEmp_Contact_Num()}" maxlength="10"
							pattern="\d{10}" required>
					</div>
					<div class="col-sm-4 form-group">
						<label>Designation</label> <input type="text"
							value="${emp.getEmp_Designation()}" required
					...
					<div class="col-sm-4 form-group">
						...
						<select class="form-control" name="Emp_Gender"
							value="${emp.getEmp_Gender()}" required>
				...
				<div class="row">
					<div class="col-sm-4 form-group">
						<label>Grade</label> <select class="form-control"
							value="${emp.getEmp_Grade()}" name="Emp_Grade" required>
					...
					<div class="col-sm-4 form-group">
						<label>Marital Status</label> <select class="form-control"
							name="Emp_Marital_Status" value="${emp.getEmp_Marital_Status()}"
							required>
